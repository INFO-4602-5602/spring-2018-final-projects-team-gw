...
var tip = d3.tip()
    ...
    .html(function(d) {
        ...
        return d.Vaccine + "<br><strong><span style='color:red'>Qty of Deaths: </strong></span>" + d.Deaths2017;
    })

var svg = d3.select("#dth").append("svg")
...
d3.csv("VaxDeaths2017v02.csv", type, function(error, data) {
  ...
  //     .attr("y", -26)
  //     .text("Number of Deaths from 7 Listed Vaccines in 2017, as named in VAERS");
